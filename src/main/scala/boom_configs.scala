...
class SmallBOOMConfig  extends Config(new WithJtagDTM ++ new WithBroomTop ++ new WithNPerfCounters(8) ++ new WithSmallBOOMs  ++ new WithAllBooms ++ new DefaultBOOMConfig ++ new BaseConfig)
