...
case class CobraFAMicroBTBParams(
  nWays: Int = 16,
  offsetSz: Int = 13
)


class FAMicroBTBBranchPredictorBank(params: CobraFAMicroBTBParams = CobraFAMicroBTBParams())(implicit p: Parameters) extends BranchPredictorBank()(p)
{
