...
//   val uopSRET = UInt(40, UOPC_SZ)
   ...
   val uopFMIN_D    = 104.U(UOPC_SZ.W)
   val uopFMAX_D    = 105.U(UOPC_SZ.W)

   val uopFADD_S    = 106.U(UOPC_SZ.W)
   val uopFSUB_S    = 107.U(UOPC_SZ.W)
   val uopFMUL_S    = 108.U(UOPC_SZ.W)
   val uopFADD_D    = 109.U(UOPC_SZ.W)
   val uopFSUB_D    = 110.U(UOPC_SZ.W)
   val uopFMUL_D    = 111.U(UOPC_SZ.W)

   val uopFMADD_S   = 112.U(UOPC_SZ.W)
   val uopFMSUB_S   = 113.U(UOPC_SZ.W)
   val uopFNMADD_S  = 114.U(UOPC_SZ.W)
   val uopFNMSUB_S  = 115.U(UOPC_SZ.W)
   val uopFMADD_D   = 116.U(UOPC_SZ.W)
   val uopFMSUB_D   = 117.U(UOPC_SZ.W)
   val uopFNMADD_D  = 118.U(UOPC_SZ.W)
   val uopFNMSUB_D  = 119.U(UOPC_SZ.W)

   val uopFDIV_S    = 120.U(UOPC_SZ.W)
   val uopFDIV_D    = 121.U(UOPC_SZ.W)
   val uopFSQRT_S   = 122.U(UOPC_SZ.W)
   val uopFSQRT_D   = 123.U(UOPC_SZ.W)

   val uopSYSTEM    = 124.U(UOPC_SZ.W) // pass uop down the CSR pipeline and let it handle it
   val uopSFENCE    = 125.U(UOPC_SZ.W)
