...
trait CanHaveBoomScratchpadBundle extends HasHellaCacheBundle with HasBoomICacheFrontendBundle {
  val outer: CanHaveBoomScratchpad
}

trait CanHaveBoomScratchpadModule extends HasHellaCacheModule with HasBoomICacheFrontendModule {
  val outer: CanHaveBoomScratchpad
