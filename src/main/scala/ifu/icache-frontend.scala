...
trait HasBoomICacheFrontend extends CanHavePTW with HasTileLinkMasterPort {
  val module: HasBoomICacheFrontendModule
  val frontend = LazyModule(new freechips.rocketchip.rocket.Frontend(tileParams.icache.get, hartid: Int))
  val hartid: Int
...
trait HasBoomICacheFrontendBundle extends HasTileLinkMasterPortBundle {
  val outer: HasBoomICacheFrontend
}

trait HasBoomICacheFrontendModule extends CanHavePTWModule with HasTileLinkMasterPortModule {
  val outer: HasBoomICacheFrontend
