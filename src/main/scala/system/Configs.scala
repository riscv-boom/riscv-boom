...
class SmallVectorVMUBoomConfig extends Config(new WithVectorBoom ++ new WithVMU ++ new WithSmallBooms ++ new WithVectorBoom ++ new DefaultBoomConfig ++ new WithNBoomCores(1) ++ new WithoutTLMonitors ++ new freechips.rocketchip.system.BaseConfig)
